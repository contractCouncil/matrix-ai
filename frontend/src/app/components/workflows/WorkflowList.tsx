...
export function WorkflowList() {
    ...
    const { user } = useAuth();
    const [custom, setCustom] = useState<MatrixAIWorkflow[]>([]);
    ...
    const [typeFilter, setTypeFilter] = useState<MatrixAIWorkflow["type"] | null>(
        null,
    );
    ...
    const getTypeMeta = (type: MatrixAIWorkflow["type"]) =>
        type === "tabular"
