...
import type { MatrixAIDocument, MatrixAIWorkflow } from "../shared/types";
...
interface Props {
    workflows: MatrixAIWorkflow[];
    workflow: MatrixAIWorkflow | null;
    onClose: () => void;
}
...
// ---------------------------------------------------------------------------
function AssistantPanel({ workflow }: { workflow: MatrixAIWorkflow }) {
    return (
...
// ---------------------------------------------------------------------------
function TabularPanel({ workflow }: { workflow: MatrixAIWorkflow }) {
...
export function DisplayWorkflowModal({ workflows, workflow, onClose }: Props) {
    ...
    const [selected, setSelected] = useState<MatrixAIWorkflow | null>(workflow);
    ...
    async function handleStartChat() {
        ...
        try {
            ...
            if (!chatId) return;
            const allDocs: MatrixAIDocument[] = [
                ...standaloneDocuments,
